...
public class Menu implements IContextMenuFactory {
    ...
    private JMenuItem addReferer;
    private JMenuItem addshiro;
    ...
    private JMenu ContentType;
    private JMenuItem jpg;
    private JMenuItem XHTML;
    private JMenuItem JSON;
    private JMenuItem streamdata;
    private JMenuItem formurlencoded;
    private JMenuItem formdata ;
    ...
    public List<JMenuItem> createMenuItems(final IContextMenuInvocation invocation) {
        ...
        addReferer = new JMenuItem("add Referer");
        addshiro = new JMenuItem("add Cookie");
        //fifox�����UserAgent
        ...
        //Content-Type
        ContentType  = new JMenu("Content-Type");
        jpg = new JMenuItem("Content-Type for jpg");
        XHTML = new JMenuItem("Content-Type for XHTML");
        JSON = new JMenuItem("Content-Type for JSON");
        streamdata = new JMenuItem("Content-Type for streamdata");
        formurlencoded = new JMenuItem("Content-Type for formurlencoded");
        formdata = new JMenuItem("Content-Type for formdata");
        ...
        ContentType.add(jpg);
        ContentType.add(XHTML);
        ContentType.add(JSON);
        ContentType.add(streamdata);
        ContentType.add(formurlencoded);
        ContentType.add(formdata);
        ...
        httpHeadModiferMenu.add(addReferer);
        httpHeadModiferMenu.add(addshiro);
        httpHeadModiferMenu.addSeparator();
        httpHeadModiferMenu.add(firefoxUA);
        httpHeadModiferMenu.add(ContentType);
        ...
        addReferer.addActionListener(new MenuActionManger(invocation));
        addshiro.addActionListener(new MenuActionManger(invocation));
        ...
        jpg.addActionListener(new MenuActionManger(invocation));
        XHTML.addActionListener(new MenuActionManger(invocation));
        JSON.addActionListener(new MenuActionManger(invocation));
        streamdata.addActionListener(new MenuActionManger(invocation));
        formurlencoded.addActionListener(new MenuActionManger(invocation));
        formdata.addActionListener(new MenuActionManger(invocation));
    ...
    public class MenuActionManger implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
            ...
            try {
				...
				if(e.getSource() == addReferer){
					request = Utilities.addIPHead(m_helpers, iReqResp,"Referer");
				}
				if(e.getSource() == addshiro){
					request = Utilities.addIPHead(m_helpers, iReqResp,"Cookie");
				}
				...
				if(e.getSource() == jpg){
					request = Utilities.ContentType(m_helpers, iReqResp, "jpg");
				}
				if(e.getSource() == XHTML){
					request = Utilities.ContentType(m_helpers, iReqResp, "XHTML");
				}
				if(e.getSource() == JSON){
					request = Utilities.ContentType(m_helpers, iReqResp, "JSON");
				}
				if(e.getSource() == streamdata){
					request = Utilities.ContentType(m_helpers, iReqResp, "streamdata");
				}
				if(e.getSource() == formurlencoded){
					request = Utilities.ContentType(m_helpers, iReqResp, "formurlencoded");
				}   
				
				if(e.getSource() == formurlencoded){
					request = Utilities.ContentType(m_helpers, iReqResp, "formdata");
				} 
